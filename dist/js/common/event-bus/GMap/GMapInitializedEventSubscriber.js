...
var GMapInitializedEventSubscriber = function (_EventSubscriber) {
  ...
  function GMapInitializedEventSubscriber(domNode, aCallback, aPriority) {
    _classCallCheck(this, GMapInitializedEventSubscriber);

    var _this = _possibleConstructorReturn(this, (GMapInitializedEventSubscriber.__proto__ || Object.getPrototypeOf(GMapInitializedEventSubscriber)).call(this, aCallback, aPriority));
